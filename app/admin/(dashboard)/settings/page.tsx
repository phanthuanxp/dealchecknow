    ...
    <div className="space-y-5">
      <section className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Chỉnh hotline, email, Zalo, tên miền và tên website. Trang công khai sẽ đọc trực tiếp các giá trị này từ SQL.
        </p>
      </section>
      ...
      <AdminSettingsForm
        ...
        defaultValues={{
          ...
          servicePricingImageUrl: settings.servicePricingImageUrl,
          servicePricingImageAlt: settings.servicePricingImageAlt
        }}
      />
    </div>
  );
